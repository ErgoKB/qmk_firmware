...
inline void led1_on(void) { led_pin_on(13); };
inline void led2_on(void) { led_pin_on(12); };

inline void led1_off(void) { led_pin_off(13); };
inline void led2_off(void) { led_pin_off(12); };
